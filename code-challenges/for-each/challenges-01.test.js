...
const greeting = (word) => {
  return(`${word} 301 students!`.toUpperCase);
};
greeting('hello');
const speaker = (message, callback) => {
  return(message.toUpperCase, callback.toUpperCase);
};
...
const createList = (availableItems) => {
  // Information taken from https://www.codecademy.com/forum_questions/50ca2bcab8098707bd0002b5
  let availableItems = ['apples', 'pears', 'oranges', 'bananas', 'blueberries'];
  fruits.forEach( function(available, index) {
    if(available == true){
