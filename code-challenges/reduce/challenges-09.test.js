...
const mapCurrentEvents = () => {
  return currentEvents.news.map(newsItem => new Event(newsItem));
}
...
const returnNames = (arr) => {
  return starWarsData.reduce((accumulator, person) => {
...
const reversedString = (str) => {
  // separate string into an array of separate characters
  // reverse the array
  // return as new array
  let array = str.split('');
  return array.reduce((accumulator, letter)=> {
